...
import PasswordForm from "./system_users/PasswordForm";
...
export default function Navbar() {
  ...
  return (
    <>
      <Disclosure as="nav" className="bg-gray-800" sx={{position: 'sticky'}}  dir="rtl"> 
        {({ open }) => (
          <>
            <div
              ...
              <div className="relative flex h-16 items-center justify-between">
                ...
                <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                  <div className="flex flex-shrink-0 items-center">
                    <img
                      className="h-8 w-auto mt-8 mr-8"
                      src="../logo.png"
                      alt="Your Company"
      ...
      <div>
        <Dialog open={opens} onClose={handleClose}>
          ...
          <DialogActions>
            <Button onClick={handleClose} variant="contained" color="secondary">بندول</Button>
          </DialogActions>
        </Dialog>
      </div>
    </>
