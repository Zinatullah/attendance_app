...
import NewTable from "./attendance/NewTable";
...
import LeaveFrom from "./attendance/LeaveFrom";
import VacationTable from "./attendance/VacationTable";
import EmployeesInfo from "./attendance/EmployeesInfo";
      ...
      <div className="p-4 sm:ml-64 mt-10">
        <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
          <div className="text-2xl text-gray-400 dark:text-gray-500">
            <EmployeesInfo
              callback={(check) => {
                handleClickOpens(check);
              }}
              handleClickOpened={handleClickOpened}
            />
          </div>
        </div>
      </div>
